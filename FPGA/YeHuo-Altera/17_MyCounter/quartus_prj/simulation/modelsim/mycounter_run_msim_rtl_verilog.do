...
vlog -vlog01compat -work work +incdir+D:/GitRepository/Practice/FPGA/YeHuo-Altera/17_MyCounter/rtl {D:/GitRepository/Practice/FPGA/YeHuo-Altera/17_MyCounter/rtl/mycounter.v}

vlog -vlog01compat -work work +incdir+D:/GitRepository/Practice/FPGA/YeHuo-Altera/17_MyCounter/quartus_prj/../sim {D:/GitRepository/Practice/FPGA/YeHuo-Altera/17_MyCounter/quartus_prj/../sim/tb_mycounter.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  tb_mycounter
